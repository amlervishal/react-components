    ...
    <>
      <div className="w-screen h-screen">
        <div className="flex flex-col items-center pt-20 gap-5">
          <h2 className="font-bold text-2xl tracking-widest drop-shadow-md">ACCORDIAN</h2>
        ...
        <div className="flex flex-col mx-auto my-10 w-5/6 md:w-1/2 gap-5 px-5 pt-5 pb-10 border rounded shadow-lg  text-slate-500">
          {data.map((item) => (
            <div key={item.id} onClick={() => toggleItem(item.id)}>
              <div className="flex flex-row justify-between font-semibold p-2 border-b-2 border-slate-800">
